...
function displayMovie(){
    ...
    <img src="../assets/movie-ranking-project/${movie['main-folder']}/${movie['poster-img']}" alt="${movie['name']}" />
    `;
...
function displayActor(){
    ...
    actorCard.innerHTML=`
        <div class="actor-card">
                <img
                  src="../assets/movie-ranking-project/${movie['main-folder']}/${movie["actor-folder"]}/${actor['img-name']}"
